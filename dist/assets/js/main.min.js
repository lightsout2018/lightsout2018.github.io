    ...
    var a = Math.PI / 180,
        ...
        if (c !== k || d !== l) {
            e = Math.abs(e), f = Math.abs(f);var m = g % 360 * a,
                ...
                v = r * r,
                w = s * s,
                x = v / t + w / u;x > 1 && (e = Math.sqrt(x) * e, f = Math.sqrt(x) * f, t = e * e, u = f * f);var y = h === _j ? -1 : 1,
                ...
                K = (-s - C) / f,
                L = Math.sqrt(H * H + I * I),
                M = H;y = 0 > I ? -1 : 1;var N = y * Math.acos(M / L) * b;L = Math.sqrt((H * H + I * I) * (J * J + K * K)), M = H * J + I * K, y = 0 > H * K - I * J ? -1 : 1;var O = y * Math.acos(M / L) * b;!_j && O > 0 ? O -= 360 : _j && 0 > O && (O += 360), O %= 360, N %= 360;var P,
                Q,
                R,
                S = i(N, O),
                T = n * e,
        ...
        var g,
            ...
            o = 999999999999,
            q = a.centerX + e,
            r = a.centerY + f;for (h = c; l > h && (g = b[h].size || p(b[h]), !(n > g)); h++) {
        ...
        var e = k(a[0]),
            f = k(a[1]);y(e, f, b || 0 === b ? b : "auto", c) && (a[0] = m(e), a[1] = m(f), ("log" === d || d === !0) && h('precompile:["' + a[0] + '","' + a[1] + '"]'));
    },
        A = function A(a, b, c) {
        ...
        var b = a[0].match(d) || [],
            c = a[1].match(d) || [],
            e = c.length - b.length;e > 0 ? a[0] = C(b, e) : a[1] = C(c, -e);
    },
        E = function E(a) {
        ...
        "string" == typeof a && (a = g.selector(a));for (var c = a && 0 !== a.length ? a.length && a[0] && a[0].nodeType ? Array.prototype.slice.call(a, 0) : [a] : [], d = c.length; --d > -1;) {
            c[d] = G(c[d], b !== !1);
        }return c;
        ...
        var c,
            ...
            l,
            m = k(H(a, !0))[0] || [],
            n = 0;if (b = b || {}, l = b.align || b.relative, f = b.matrix || [1, 0, 0, 1, 0, 0], h = b.offsetX || 0, i = b.offsetY || 0, "relative" === l || l === !0 ? (h -= m[0] * f[0] + m[1] * f[2], i -= m[0] * f[1] + m[1] * f[3], n = "+=") : (h += f[4], i += f[5], l && (l = "string" == typeof l ? g.selector(l) : l && l[0] ? l : [l], l && l[0] && (j = l[0].getBBox() || { x: 0, y: 0 }, h -= j.x, i -= j.y))), c = [], e = m.length, f) for (d = 0; e > d; d += 2) {
            c.push({ x: n + (m[d] * f[0] + m[d + 1] * f[2] + h), y: n + (m[d] * f[1] + m[d + 1] * f[3] + i) });
...
(function () {
    ...
    var elLogoWrapper = document.getElementById("logo-wrapper");
